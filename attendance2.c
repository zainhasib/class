            ...
            case 6:
                ...
                for(k=0;k<5;k++) {
                    ...
                    for(l=0;l<5;l++) {
                        ...
                        att += subject[k].student[l].average;
                        printf("Student %d has %d percent attendence\n", l+1, subject[k].student[l].average);
                    }
                    subject[k].average = att / 5.0;
                    printf("Average %d \n\n", subject[k].average);
                }

                printf("Students with attendence below average attendence of class are : \n");
                for(k=0;k<5;k++) {
                    printf("Subject code: %d\n", k);
                    for(l=0;l<5;l++) {
                        if(subject[k].student[l].average < subject[k].average) {
                            printf("Student %d\n", l+1);
                        }
                    }
                    printf("\n\n");
